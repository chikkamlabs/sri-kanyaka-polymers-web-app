...
export default function AddProductPage() {
  ...
  // Form Fields - All fields in products table
  ...
  useEffect(() => {
    ...
    async function initializePage() {
      ...
      try {
        ...
        if (mounted) {
          const suggestedNum = 101 + productsList.length;
          setUniqueId(`Prod-${suggestedNum}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage(err.message || 'Failed to create product in Supabase.');
      setSaving(false);
    }
  };
          ...
          <div className="bg-[#FFFCF8] border border-[#DDD3C6] rounded-2xl p-6 shadow-sm mb-6 flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#8A7B70] mt-0.5">
                Register a new inventory product item into Sri Kanyaka Polymers ERP
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#8A7B70] mt-1">
                  Suggested automatically as Prod-101+count. You can edit if needed.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-[11px] text-[#8A7B70] mt-1">
                  Triggers low stock alert when quantity &lt; threshold.
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. PCS, METERS, BUNDLE"
